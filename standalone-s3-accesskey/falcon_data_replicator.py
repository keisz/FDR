    ...
    def __init__(self, config: configparser.ConfigParser):
        ...
        try:
            ...
            if "Destination Data" in config:
                ...
                if config["Destination Data"]["TARGET_AWS_KEY"]:
                    # AWS Access Key of our target S3 bucket
                    self.target_aws_key = config["Destination Data"]["TARGET_AWS_KEY"]

                if config["Destination Data"]["TARGET_AWS_SECRET"]:
